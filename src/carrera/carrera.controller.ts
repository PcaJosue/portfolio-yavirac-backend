...
export class CarreraController {
  ...
  @Get()
  @ApiOkResponse({ status: 200, description: 'The query has been successfully.', type: Carrera})
  ...
  @Get(':id')
  @ApiOkResponse({ status: 200, description: 'Successfully retrieved item.', type: Carrera})
  ...
  @Get('/search/by')
  @ApiOkResponse({ status: 200, description: 'The query has been successful.', type: Carrera})
  ...
  @ApiOkResponse({ status: 200, description: 'The Catalogue has been successfully created.', type: CreateCarreraDto  })
  ...
  @ApiOkResponse({ status: 200, description: 'The Catalogue has been successfully updated.', type: UpdateCarreraDto  })
  ...
  @Delete(':id')
  @ApiOkResponse({ status: 200, description: 'The Catalogue has been successfully deleted.', type:  Carrera })
  @ApiNotFoundResponse({ status: 404, description: 'Catalogue not found.' })
